...
data_file 'DLC_ITYP_REQUEST' 'stream/Harugahara/HarugaharaV2.ytyp'
data_file 'DLC_ITYP_REQUEST' 'stream/ebisuMinami/NFEbisuMinami.ytyp'
data_file 'DLC_ITYP_REQUEST' 'stream/haruna/haruna.ytyp'
...
data_file 'DLC_ITYP_REQUEST' 'stream/myogi/myogi.ytyp'

data_file 'DLC_ITYP_REQUEST' 'stream/ohiradai/ohiradai.ytyp'
file 'meta/ohiradai/gtxd.meta'
data_file 'GTXD_PARENTING_DATA' 'meta/ohiradai/gtxd.meta' 
